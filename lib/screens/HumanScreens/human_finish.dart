...
class HumanFinishGameScreenOne extends StatefulWidget {
  const HumanFinishGameScreenOne({super.key});
  @override
  State<HumanFinishGameScreenOne> createState() =>
      _HumanFinishGameScreenState();
}

class _HumanFinishGameScreenState extends State<HumanFinishGameScreenOne> {
  @override
    ...
    return Material(
      child: Column(
        children: [
          ...
          Text(
            'human_finish             ${context.watch<RandomNumberProvider>().randomNumber}',
